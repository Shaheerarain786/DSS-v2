                ...
                <div class="panel panel-bordered">
                    ...
                    <div class="panel-body">
                        ...
                        <button id="deleteBtn" type="button"
                                class="btn btn-primary btn-rounded pull-right btn-hover-danger"><i
                                ...
                                <table id="branches" class="table table-bordered">
                                    ...
                                    @foreach($zones as $key => $zone)
                                        <tr>
                                            <td>
                                                <div class="checkbox">
                                                    <input data-zone_id="{{$zone->id}}" id="zone-check-{{$zone->id}}"
                                                           value="{{$zone->id}}" class="magic-checkbox" type="checkbox">
